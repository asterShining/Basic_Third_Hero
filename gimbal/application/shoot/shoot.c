...
static DJIMotorInstance *friction_inner_up, *friction_inner_left, *friction_inner_right; // 内部摩擦轮电机
static DJIMotorInstance *friction_outer_up, *friction_outer_left, *friction_outer_right; // 外部摩擦轮电机
